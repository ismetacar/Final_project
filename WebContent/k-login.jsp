...
<body>
	<div id="outer">
		<div id="header">
			<div id="logo">
				<h1>
					<a href="#">Samarango Icin Musteri Girisi</a>
				</h1>
			</div>
			<div id="nav">
				<ul>
		...
		<div class="page-container">
			<h1>Login</h1>
			<form action="kullaniciServlet" method="get">
				<input type="text" name="username" class="username"
					placeholder="Kullanici Adi"> <input type="password"
					name="password" class="password" placeholder="Sifre">
			...
			<button onclick="window.location.href='signup.jsp'">Sign Up</button></br>
			${kullaniciyok}
			<div class="connect">
				<p>Or connect with:</p>
				<p>
